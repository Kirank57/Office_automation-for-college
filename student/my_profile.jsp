...
<input value="<%=rs.getInt("st_id")%>" name="id" type="hidden" />		
   ...
   <div class="form-group">
	...
	<div class="form-group">
    <label>E-mail</label>
  <input class="validate[required] form-control"name="st_email" type="text" readonly="" id="st_email" value="<%=rs.getString("st_email")%>">
  </div>
