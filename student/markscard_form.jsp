...
<form id="WFS_Riz"name="form1" method="post" action="markscard_insert.jsp">
   ...
   <div class="form-group">
    ...
    <label>Marks Card Date</label>
	   ...
	   <div style="float:left "> <img src="calender/cal.gif" align="right" onMouseOver="fnInitCalendar(this,'m_date','style=calendar.css,expiry=false,instance=single,close=true')"></div>
