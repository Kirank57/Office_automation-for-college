...
<input name="id" type="hidden" value="<%=a%>">
 <div class="form-group">
    <label>Sem</label>
      <td><input class="validate[required,custom[onlyNumber]] form-control"name="sem" type="text" id="sem" value="<%=rs.getString("sem")%>"></td>
...
<jsp:getProperty name="s1" property="conn"/>
   ...
   <div class="form-group">
    <label>Markscard Status</label>
     <input class="validate[required,custom[onlyLetter]] form-control"name="m_status" type="text" id="m_status" value="<%=rs.getString("m_status")%>">
   </div>
