...
int z=s.stm.executeUpdate("Update staff_details set b_id='"+a+"',s_fname='"+b+"',s_lname='"+c+"',s_contact='"+d+"',s_email='"+e+"',s_qualification='"+f+"',s_designation='"+g+"',s_address='"+h+"',s_photo='"+i+"',s_salary='"+j+"' where s_id='"+k+"'");
%>
<script>
