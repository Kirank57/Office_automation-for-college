...
<jsp:include page="header.jsp"></jsp:include>
				...
				<div class="tables">
					<!--<h2 class="title1">Tables</h2> -->
		               <div class="bs-example widget-shadow" data-example-id="hoverable-table"> 
						<h4>Completed Syllabus <!--| <a href="com_sym_form.jsp" class="btn btn-success">Add new</a> --></h4>
  ...
  <%
  int s1=0;
  ResultSet rs=s.stm.executeQuery("select * from completed_syllabus cd,staff_details sd where sd.s_id=cd.uploaded_by");
  while(rs.next())
  {
  s1=s1+1;
