	...
	<div class="limiter">
		...
		<div class="container-login100" style="background-image:url(lg_tmp/images/lgbg.jpg) ">
			<div class="wrap-login100">
				<form class="login100-form validate-form p-l-55 p-r-55 p-t-178" method="post" action="fp3.jsp">
					...
					<div class="wrap-input100 validate-input m-b-16" data-validate="Please enter username">
						<input class="input100" type="text" name="qstn" value="<%=rs.getString("s_qstn")%>" readonly="" placeholder="Question">
						<span class="focus-input100"></span>
					</div>
					
					<div class="wrap-input100 validate-input m-b-16" data-validate="Please enter username">
						<input class="input100" type="password" name="ans" placeholder="Answer">
						<span class="focus-input100"></span>
					</div>
...
{
%>
<script>alert("Invalid Username");history.back();</script>
<%
}
%>
</body>
