					...
					<ul class="nofitications-dropdown">
						<li class="dropdown head-dpdn">
							...
							<!-- <ul class="dropdown-menu">
								...
								<li><a href="#">
								   <div class="user_img"><img src="./wfs_temp/images/1.jpg" alt=""></div>
						...
						<li class="dropdown profile_details_drop">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
								<div class="profile_img">	
									<span class="prfil-img"><img src="./wfs_temp/images/wfs_logo.png" width="50" height="50" alt=""> </span> 
									<div class="user-name">
										<p>Welcome, Riz</p>
										<span>Admin</span>
									</div>
							...
							<ul class="dropdown-menu drp-mnu">
								...
								<li> <a href="changepassword_form.jsp"><i class="fa fa-lock"></i> Change Password</a> </li> 
