...
<jsp:include page="header.jsp"></jsp:include>
  ...
  ResultSet rs=s.stm.executeQuery("select * from quary_details qd,student_details sd,staff_details stf where qd.q_from=sd.st_id and qd.q_to=stf.s_id and stf.s_email='"+un+"'");
  while(rs.next())
  {
  s1=s1+1;
  ...
  <tr>
	...
	<td><div align="center"><a href="quary_rply.jsp?qid=<%=qid%>"><button class="btn btn-warning">Replay</button></a></div></td>
	<% } else { %>
	<td><div align="center"><%=ans%></div></td>
    <td><div align="center"><%=rs.getString("uploaded_ans_date")%></div></td>
	<td><div align="center">-</div></td>
	<% } %>
  </tr>
