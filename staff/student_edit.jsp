...
<jsp:getProperty name="s1" property="conn"/>
    ...
    <label>First Name</label>
      <td><input class="validate[required,custom[onlyLetter]] form-control" name="st_fname" type="text" id="st_fname" value="<%=rs.getString("st_fname")%>"></td>
   
   <div class="form-group">
    <label>Last Name</label>
      <input class="validate[required,custom[onlyLetter]] form-control" name="st_lname" type="text" id="st_lname" value="<%=rs.getString("st_lname")%>">
	  </div>
