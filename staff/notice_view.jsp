...
<jsp:include page="header.jsp"></jsp:include>
  ...
  ResultSet rs=s.stm.executeQuery("select * from notice_details nd,student_details st,staff_details sd where nd.n_from=sd.s_email and nd.n_to=st.st_id");
  while(rs.next())
  {
  s1=s1+1;
  ...
  <tr>
    ...
    <td><div align="center">  <a class="btn btn-danger" onClick="return confirm('Are you sure?')" href="notice_delete.jsp?id=<%=nid%>"><i class="fa fa-trash"></i></a> </div></td>
  </tr>
  <%
  }
  %>
