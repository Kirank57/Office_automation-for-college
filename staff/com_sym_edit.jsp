...
<input name="id" type="hidden" value="<%=a%>">
 <label>Title </label>
   ...
   <label>Description </label>
	 <div class="form-group">
      <textarea class="validate[required,custom[onlyLetter]] form-control"name="description" id="description"><%=rs.getString("description")%></textarea>
   </div>
	...
	<div class="form-group">
      <input class="validate[required,custom[onlyLetter]] form-control"name="uploaded_by" type="text" id="uploaded_by" value="<%=rs.getString("uploaded_by")%>"></td>
   </div>
   
    <label>Status </label>
	<div class="form-group">
      <td><input class="validate[required,custom[onlyLetter]] form-control"name="status" type="text" id="status" value="<%=rs.getString("status")%>">
   </div>
