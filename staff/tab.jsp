...
<!-- main content start-->
		<div id="page-wrapper">
			...
			<div class="col-md-3 widget widget1">        		<div class="r3_counter_box">                    <i class="pull-left fa fa-users icon-rounded"></i>                    <div class="stats">                      <h5><strong><%=ts%></strong></h5>                      <span>Total Students</span>                    </div>                </div>        	</div>
			
        	<div class="col-md-3 widget widget1">        		<div class="r3_counter_box">                    <i class="pull-left fa fa-user user1 icon-rounded"></i>                    <div class="stats">                      <h5><strong><%=sf%></strong></h5>                      <span>Total Staff</span>                    </div>                </div>        	</div>
