...
<jsp:getProperty name="s" property="conn"/> 
				...
				ResultSet rs=s.stm.executeQuery("select * from staff_details sd,login l where sd.s_email=l.username and l.username='"+un+"'");
				rs.next();
				%>
						...
						<li class="dropdown profile_details_drop">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
								<div class="profile_img">	
									<span class="prfil-img"><img src="../uploads/<%=rs.getString("s_photo")%>" width="50" height="50" alt=""> </span> 
									<div class="user-name">
										<p>Welcome,<%=rs.getString("s_fname")%>&nbsp;<%=rs.getString("s_lname")%></p>
										<span>Staff pannel</span>
									</div>
