...
<jsp:include page="header.jsp"></jsp:include>
  ...
  ResultSet rs=s.stm.executeQuery("select * from rating_details rd,staff_details sd,student_details std where rd.s_id=sd.s_id and rd.st_id=std.st_id and sd.s_email='"+un+"'");
  while(rs.next())
  {
  s1=s1+1;
  ...
  <thead>
    ...
    <td><div align="center" style="filter: blur(4px);"><%=rs.getString("st_fname")+" "+rs.getString("st_lname")%></div></td>
