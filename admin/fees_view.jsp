				...
				<div class="tables">
					<!--<h2 class="title1">Tables</h2> -->
		               <div class="bs-example widget-shadow" data-example-id="hoverable-table"> 
						<h4>Fees Details | <a href="fees_select.jsp" class="btn btn-success">Add new</a></h4>
...
<tbody>
  <tr>
	...
	<td><div align="center"><a href="fees_edit.jsp?id=<%=fid%>&bl=<%=blc%>"><button class="btn btn-info">Pay</button></a></div></td>
	<% } %>
  </tr>
  <%
  }
