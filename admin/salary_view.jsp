...
<jsp:include page="header.jsp"></jsp:include>
				...
				<div class="tables">
					<!--<h2 class="title1">Tables</h2> -->
		               <div class="bs-example widget-shadow" data-example-id="hoverable-table"> 
						<h4>Salary Details | <a href="salary_form.jsp" class="btn btn-success">Pay Salary</a></h4>
						<div style="overflow-x:auto;">
	<table class="table table-hover" width="100%"> 
	<thead>
  <tr>
    <td width="59" height="27"><div align="center"><strong>SR No </strong></div></td>
    <td width="110"><div align="center"><strong>Staff ID </strong></div></td>
  ...
  <%
  int s1=0;
  ResultSet rs=s.stm.executeQuery("select * from salary_details sal,staff_details sd where sal.s_id=sd.s_id");
  while(rs.next())
  {
  s1=s1+1;
  ...
  <tr>
    ...
    <td><div align="center"><!-- <a class="btn btn-primary" href="salary_edit.jsp?id=<%=salid%>"><i class="fa fa-edit"></i></a> |  --><a class="btn btn-danger"onClick="return confirm('Are you sure?')" href="salary_delete.jsp?id=<%=salid%>"><i class="fa fa-trash"></i></a></div></td>
  </thead>
  </tr>
  <%
  }
