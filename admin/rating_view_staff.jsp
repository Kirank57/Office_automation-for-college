...
<jsp:include page="header.jsp"></jsp:include>
				...
				<div class="tables">
					<!--<h2 class="title1">Tables</h2> -->
		               <div class="bs-example widget-shadow" data-example-id="hoverable-table"> 
						<h4>Rating Details | <a href="rating_view.jsp">Show All</a></h4>
  ...
  <%
  int s1=0;
  String sdd=request.getParameter("sid");
  ResultSet rs=s.stm.executeQuery("select * from rating_details rd,staff_details sd,student_details std where rd.s_id=sd.s_id and rd.st_id=std.st_id and rd.s_id='"+sdd+"'");
  while(rs.next())
  {
  s1=s1+1;
