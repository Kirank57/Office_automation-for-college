...
<jsp:include page="header.jsp"></jsp:include>
				...
				<div class="tables">
					<!--<h2 class="title1">Tables</h2> -->
		               <div class="bs-example widget-shadow" data-example-id="hoverable-table"> 
						...
						<div style="width:80%">
						<form action="staff_view_br.jsp" method="post">
  ...
  <tr>
    ...
    <td width="88"><div align="center"><strong>Branch</strong></div></td>
    <td width="79"><div align="center"><strong>Full Name</strong></div></td>
    <td width="98"><div align="center"><strong>Contact</strong></div></td>
    <td width="98"><div align="center"><strong>E-mail</strong></div></td>
  ...
  ResultSet rs=s.stm.executeQuery("select * from staff_details sd,branch_details bd where sd.b_id=bd.b_id and sd.b_id='"+br+"'");
  while(rs.next())
  {
  s1=s1+1;
