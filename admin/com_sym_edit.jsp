...
<label>Title </label>
   ...
   <label>Description </label>
	 <div class="form-group">
    <textarea class="validate[required,custom[onlyLetter]] form-control"name="description" id="description"><%=rs.getString("description")%></textarea></td>
   </div>
   
      <label>Uploaded date  </label>
	<div class="form-group">
      <td><input class="validate[required] form-control"name="uploaded_date" type="text" id="uploaded_date" value="<%=rs.getString("uploaded_date")%>">
    </div>
