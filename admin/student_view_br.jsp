...
<jsp:include page="header.jsp"></jsp:include>
				...
				<div class="tables">
					<!--<h2 class="title1">Tables</h2> -->
		               <div class="bs-example widget-shadow" data-example-id="hoverable-table"> 
						<h4>Student Details | Sort Sem / Batch Wise<!--  <a href="student_form.jsp" class="btn btn-success">Add new</a> --></h4>
						<div style="width:50%">
						...
						<td width="250">
						<form action="student_view_br.jsp" method="post">
  ...
  ResultSet rs=s.stm.executeQuery("select * from student_details sd,branch_details bd where sd.b_id=bd.b_id and sd.b_id='"+br+"'");
  while(rs.next())
  {
  s1=s1+1;
