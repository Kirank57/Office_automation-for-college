...
<jsp:include page="header.jsp"></jsp:include>
  ...
  ResultSet rs=s.stm.executeQuery("select * from markscard_details md,student_details std,branch_details bd where bd.b_id=std.b_id and md.st_reg=std.st_regno and std.b_id='"+br+"'");
  while(rs.next())
  {
  s1=s1+1;
